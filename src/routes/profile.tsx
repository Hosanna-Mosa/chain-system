...
const stats = [
  ...
  { label: "CV Earned", value: "1,250", icon: "toll", color: "#efa500" },
  { label: "Days Active", value: "147", icon: "calendar_month", color: "#3adfab" },
    ...
    <div className="min-h-screen relative overflow-x-hidden flex flex-col bg-[#0e0d17]">
      ...
      <main className="flex-1 pt-24 pb-32 px-4 sm:px-6 w-full max-w-3xl mx-auto space-y-6">
        ...
        <div className="relative overflow-hidden glass-card rounded-[24px] p-8 border border-white/5">
          ...
          <div className="absolute -top-20 -right-20 w-60 h-60 bg-[#6C47FF]/15 blur-[100px] rounded-full pointer-events-none" />

          <div className="relative flex flex-col sm:flex-row items-center sm:items-start gap-6">
            {/* Avatar */}
            <div className="relative flex-shrink-0">
              <div className="w-24 h-24 rounded-2xl overflow-hidden border-2 border-[#6C47FF]/40 shadow-[0_0_30px_rgba(108,71,255,0.3)]">
                <img
              ...
              <div className="absolute -bottom-1 -right-1 w-6 h-6 bg-[#3adfab] rounded-full border-2 border-[#0e0d17] flex items-center justify-center">
                <span className="material-symbols-outlined text-[10px] text-[#0e0d17] font-black">check</span>
              </div>
            </div>
            ...
            <div className="flex-1 text-center sm:text-left min-w-0">
              ...
              <div className="mt-4 flex flex-wrap gap-2 justify-center sm:justify-start">
                <button className="flex items-center gap-1.5 text-xs font-bold bg-[#6C47FF]/10 border border-[#6C47FF]/20 text-[#6C47FF] hover:bg-[#6C47FF]/20 px-3 py-1.5 rounded-lg transition-colors">
        ...
        <div className="glass-card rounded-[18px] p-5 border border-white/5">
          ...
          <div className="flex gap-2">
            ...
            <button className="bg-[#6C47FF]/10 border border-[#6C47FF]/20 text-[#6C47FF] hover:bg-[#6C47FF] hover:text-white px-4 rounded-xl transition-all font-bold text-xs flex items-center gap-1">
            ...
            <div key={group.group}>
              ...
              <div className="glass-card rounded-[18px] border border-white/5 divide-y divide-white/5 overflow-hidden">
                {group.items.map((item) => (
                  ...
                  >
                    <div className="w-9 h-9 rounded-xl bg-white/5 border border-white/5 flex items-center justify-center flex-shrink-0 group-hover:bg-[#6C47FF]/10 group-hover:border-[#6C47FF]/20 transition-colors">
                      <span className="material-symbols-outlined text-[18px] text-white/50 group-hover:text-[#6C47FF] transition-colors">{item.icon}</span>
                    </div>
